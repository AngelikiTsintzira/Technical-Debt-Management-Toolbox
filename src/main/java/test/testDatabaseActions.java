...
class testDatabaseActions {
	...
	void testSaveDataC() throws IOException, SQLException
	{
		...
		dataC.saveMetricsInDatabase("Project", 0, "class1", "FIL", 244, 3.4, 432, 333, 32.2, 32, "hash");
	...
	void testSaveDataJava() throws IOException, SQLException
	{
		...
		/*
		preData.getInterestMetricsJava("ProjectJava", "FIL", "0") ;
		preData.getInterestMetricsJava("ProjectJava", "DIR", "0") ;
