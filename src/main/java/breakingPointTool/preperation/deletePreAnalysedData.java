...
public class deletePreAnalysedData 
{
	...
	public boolean DeleteFromDBAlreadyAnalysedVersion(String projectName, String language, int version)
	{
	...
	public boolean DeleteFromDBAlreadyAnalysedProject(String projectName, String language)
	{
		Connection conn = DatabaseConnection.getConnection();
		PreparedStatement pstm = null;
		ResultSet resultSet = null;
