...
/**
 * 
 * The BaseController class implements common functionality for all Controller classes. 
 * The <code>@ExceptionHandler</code> methods provide a consistent response when Exceptions are thrown from <code>@RequestMapping</code> annotated Controller methods.
 *
 */
